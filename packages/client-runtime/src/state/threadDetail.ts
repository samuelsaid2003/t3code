...
export function mergeEnvironmentThread(
  ...
  return {
    ...
    kind: shell.kind ?? detail.kind,
    agentProfile: shell.agentProfile === undefined ? detail.agentProfile : shell.agentProfile,
    agentRoutines: shell.agentRoutines === undefined ? detail.agentRoutines : shell.agentRoutines,
    agentRuns: shell.agentRuns === undefined ? detail.agentRuns : shell.agentRuns,
    title: shell.title,
