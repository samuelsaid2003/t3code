...
import {
  ...
  type UpsertAgentRoutineInput,
  type DeleteAgentRoutineInput,
...
export type {
  ...
  UpsertAgentRoutineInput,
  DeleteAgentRoutineInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    updateAgentProfile: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:agent:update-profile",
      execute: (input: UpdateAgentProfileInput) => updateAgentProfile(input),
      scheduler,
      concurrency,
    }),
    upsertAgentRoutine: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:agent:upsert-routine",
      execute: (input: UpsertAgentRoutineInput) => upsertAgentRoutine(input),
      scheduler,
      concurrency,
    }),
    deleteAgentRoutine: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:agent:delete-routine",
      execute: (input: DeleteAgentRoutineInput) => deleteAgentRoutine(input),
      scheduler,
      concurrency,
    }),
    requestAgentRun: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:agent:request-run",
      execute: (input: RequestAgentRunInput) => requestAgentRun(input),
      scheduler,
      concurrency,
    }),
