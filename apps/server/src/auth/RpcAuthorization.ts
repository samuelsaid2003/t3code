...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.resolveForwardSources]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.vcsListTree]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsReadFileAtRef]: AuthOrchestrationReadScope,
