...
import { AgentRoutineReactor } from "../Services/AgentRoutineReactor.ts";
...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, deletion, and routine reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(AgentRoutineReactor, {
            start: () => {
              started.push("agent-routine-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
