 ...
 * Code subprocess completes its local initialization IPC without sending
 * the prompt. After initialization we make the SDK's lightweight account-
 * usage request, then abort the subprocess.
 *
